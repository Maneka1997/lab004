...
public class Item {
	...
	{ 
	 ...
	 con= DriverManager.getConnection("jdbc:mysql://localhost:3306/thirdyearfirstsemester",  "root", ""); 
	 //For testing
	 ...
	 return con; 
		...
		public void update(String code,String name) {
			String query="update items set itemName=? where itemCode=?;";
			String abc="update successful";
			try
			 { 
			 Connection con = connect(); 
			 if (con == null) 
